    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 items-center gap-7">
      <div className="space-y-9">
        ...
        <div className="space-x-2">
          <Link to="/add">
            <button className="font-semibold px-10 border-2 border-primary py-2 bg-primary rounded-md text-white">
              Write Blog
            </button>
          </Link>
          <Link to="/blogs">
            <button className="font-semibold px-10 border-2 border-primary py-2 text-primary rounded-md bg-transparent">
              See All Blogs
            </button>
          </Link>
        </div>
